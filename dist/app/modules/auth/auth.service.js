...
const loginUserFromDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //create token
    const createToken = jwtHelper_1.jwtHelper.createToken({ id: isExistUser._id, role: isExistUser.role, email: isExistUser.email }, config_1.default.jwt.jwt_secret, config_1.default.jwt.jwt_expire_in || '2592000');
    return { createToken };
});
//forget password
...
const resetPasswordToDB = (token, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashPassword = yield bcryptjs_1.default.hash(newPassword, Number(config_1.default.bcrypt_salt_rounds));
    const updateData = {
